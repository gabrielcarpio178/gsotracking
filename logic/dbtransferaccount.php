...
sleep(1);
if(isset($_POST['fullname'])&&isset($_POST['sex'])&&isset($_POST['birthday'])&&isset($_POST['email'])&&isset($_POST['pnumber'])&&isset($_POST['employee_id'])&&isset($_POST['department'])&&isset($_POST['position'])){
    ...
    $isValidEmail = isValid($conn, $email);
    if($isValidEmail!==1){
