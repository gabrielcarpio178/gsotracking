    ...
    <div class="container">
            ...
            <table class="styled-table">
                ...
                <tbody id="officeTbody">
                    ...
                    foreach ($data2['office'] as $row2) {
                        ...
                        echo '<td>' . htmlspecialchars($row2['date_stored']) . '</td>';
                        echo '<td>
        ...
        <div class="constructioncontent">
            ...
            <!-- <div class="mainconstruction"> -->
                <div class="mainconstructionheader " style="width: 100%; position:relative;">

                      <i class="fa-solid fa-angle-left back-button" style=" position:absolute; left:0; "></i>
                    <span style="margin-left: 2rem;">Construction</span>
        ...
        <div class="electronicscontent">
            ...
            <div class="electronicsheader" style="margin-top: -20rem;">
                Add New Product
            </div>

            <!-- <div class="mainelectronics" style="background-color: #007bff;"> -->
                <div class="mainelectronicsheader back-button" style="position: relative; width:100%">
                    <i class="fa-solid fa-angle-left"></i>
                    <span>Electronics</span>
                </div>
            ...
            <table class="styled-table electronics-table" style="width: 100%;">
                <thead>
                    <tr>
                        <th>Equipment</th>
                        <th>Quantity</th>
        ...
        <div class="itcontent">
            <div class="itheader" style="margin-top: -17rem;">
                Add New Product
            </div>

            <div class="mainit" style="
            background-color:#ffffff;">
                <div class="mainitheader back-button" style="background-color: #ffffff;">
                    <i class="fa-solid fa-angle-left back-button"></i>
                    <span>IT</span>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadTableData(category) {
                $.ajax({
                    url: '../../logic/READ/fetchDataCategory.php',
                    method: 'POST',
                    data: {
                        category: category
                    },
            ...
            function addNewProduct(category, modalSelector) {
                ...
                $.ajax({
                    url: '../../logic/CREATE/addDataCategory.php',
                    method: 'POST',
                    data: {
                        category: category,
                        equipment: equipment,
            ...
            function editProduct(id, category, equipment, quantity, price) {
                $.ajax({
                    url: '../../logic/UPDATE/editDataCategory.php',
                    method: 'POST',
                    data: {
                        id: id,
                        category: category,
            ...
            $('#saveEdit').click(function() {
                ...
                console.log(id, category, equipment, quantity, price);
            });
            ...
            // Close modals when clicking on <span> (x)
            $('.it-edit-close').click(function() {
                $(this).closest('.it-edit-modal').hide();
            });
